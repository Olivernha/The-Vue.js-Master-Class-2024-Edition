...
const ErrorTemplate = import.meta.env.DEV ? defineAsyncComponent(()=> import('@/components/AppError/AppErrorDevSection.vue')) : defineAsyncComponent(() => import('@/components/AppError/AppErrorProdSection.vue'))
